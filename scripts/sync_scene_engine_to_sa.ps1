...
$headers = @("geo.h","anchors.h","theta.h","leave_hsmm.h","scene_engine.h","baseline_runtime.h","radio_evidence.h","pdr_evidence.h","baro_evidence.h","anchor_reestimate.h","personalization.h","personalization_policy.h","product_store.h","evidence_query.h","action_ops.h","theta_eval.h","crs.h","types.h")
$sources = @("anchors.cpp","theta.cpp","leave_hsmm.cpp","scene_engine.cpp","baseline_runtime.cpp","radio_evidence.cpp","pdr_evidence.cpp","baro_evidence.cpp","anchor_reestimate.cpp","personalization.cpp","personalization_policy.cpp","product_store.cpp","evidence_query.cpp","action_ops.cpp","theta_eval.cpp","crs.cpp")
