...
$headers = @("geo.h","anchors.h","theta.h","scene_engine.h","baseline_runtime.h","personalization.h","product_store.h","evidence_query.h","action_ops.h","crs.h","types.h")
$sources = @("anchors.cpp","theta.cpp","scene_engine.cpp","baseline_runtime.cpp","personalization.cpp","product_store.cpp","evidence_query.cpp","action_ops.cpp","crs.cpp")
