...
| 中止离开解释与有序返回取消 | [ABORTED_LEAVE_PERSONALIZATION.md](ABORTED_LEAVE_PERSONALIZATION.md) |
| 可替代返回路径、Agent证据与去重回放 | [RETURN_PATH_ROBUSTNESS.md](RETURN_PATH_ROBUSTNESS.md) |
| Agent多分辨率时序证据 | [MULTIRESOLUTION_AGENT_EVIDENCE.md](MULTIRESOLUTION_AGENT_EVIDENCE.md) |
...
| Agent 通用研究提示词与验证边界 | `AGENT_RESEARCH_PROMPT.md` |
